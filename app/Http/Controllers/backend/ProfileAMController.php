...
class ProfileAMController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('backend.manager.page.profile.editProfile', compact('user'));
    }
    ...
    public function edit()
    {
        $user = auth()->user();
        $data['user'] = $user;
        return view('backend.manager.page.profile.editProfile', $data, array('user'=>Auth::user()));
    }
