    ...
    <div class="full-page">
        <div class="menu-information">
            <ul>
                ...
                <li><a href="/information/privacy"
                        style="background-color:rgb(196, 148, 13); color:rgb(253, 253, 253); border-radius: 40px">Privacy
                        Policy</a></li>
            </ul>
        </div>
        <div class="card-t">
            <div class="image-t">
                <img src={{ asset('images/p.jpg') }} alt="">
            </div>

            <div class="terms-container">
                <div class="terms-body">
                    <h3><strong>Effective Date : August, 2022</strong></h3>
                    <p>
                        PT.Global Jet Express ("us", "we", or "our") operates the J&T Express Website (the "Service").
                    ...
                    <h3>Usage Data</h3>
                    <p>
                        When you access the Service by or through a personal computer or mobile device, we may collect
                    ...
                    <h3>Use of Data</h3>
                    <p>
                        PT.Global Jet Express uses the collected data for various purposes:
                    ...
                    <p>Your information, including Personal Data, may be transferred to — and maintained on — computers
                        ...
                        If you are located outside Cambodia and choose to provide information to us, please note that we
                        transfer the data, including Personal Data, to Cambodia and process it there.

                        Your consent to this Privacy Policy followed by your submission of such information represents your
                        agreement to that transfer.
                        PT.Global Jet Express will take all steps reasonably necessary to ensure that your data is treated
                    ...
                    <p>
                        ...
                        acceptable means to protect your Personal Data, we cannot guarantee its absolute security. This
                        becomes invalid, insofar as the liability can be proven due to negligence, unilateral action or
                        neglect of the designated service provider and / or third party.
                    </p>
                    <hr>
                    ...
                    <p>
                        ...
                        are obligated not to disclose or use it for any other purpose based on the 2016/679 about General
                        Data Protection (EU) Regulations and applicable laws and codes of ethics in Cambodia.
                    </p>
                    <hr>
