                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('branch.store') }}" class="custom-validation" method="POST">
                        ...
                        <div class=" row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="tel" class="form-control" id="phone" required parsley-type="phone"
                                    pattern="[0-9]{7-12}" name="phone"
                                    placeholder="Phone number must contain min 7 digits, max 12 digits" />
                            </div>
                        </div>
                        <div class=" row mb-3">
